...
public class UserService implements UserDetailsService {
    ...
    @Autowired
    public UserService(UserRepository userRepository, TokenService tokenService, UserProfileService userProfileService, UserInterestService userInterestService) {
